...
![](https://images.velog.io/images/mertyn88/post/df2bfa92-2518-4730-b46c-51cb4b9262b9/image.png)
...
예를들어 2번째 예시의 마지막셀 `18`은 `101`보다 작은 값이므로 조건을 충족하지 못해 `101` 셀이 초록섹 셀로 변경되지 않았으며 `101`이 3의 값으로 가장 높은 값을 가지고 있었음에도 `7`의 값 2+1이 되어 할당 값은 3이다 
...
### 테스트 결과
![](https://images.velog.io/images/mertyn88/post/f2babb05-ce5a-4992-82a2-3b79776b8c68/image.png)
...
[Git Solution](https://github.com/mertyn88/algorithm/blob/feature/wordbreak/src/com/algorithm/leetcode/wordbreak/Solution.java)
...
![](https://images.velog.io/images/mertyn88/post/cbf1731c-9931-48d6-836d-51eb1539baa0/image.png)
...
### 테스트 결과
![](https://images.velog.io/images/mertyn88/post/56c5cf7c-e144-421f-b07c-5f48351d05b9/image.png)
